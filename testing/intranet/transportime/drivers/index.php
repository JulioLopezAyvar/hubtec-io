                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="py-3 text-center">
                            <h1 class="display-6">Conductores</h1>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newDriver">
                                Agregar conductor
                            </button>

                            <div class="modal fade" id="newDriver" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="newDriverLabel" aria-hidden="true">
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="newDriverLabel">Nuevo conductor</h1>
                                ...
                                <?php
                                    $stmt = $conn->prepare("
                                        SELECT
                                            ...
                                            c2880645_ttime.drivers.phone_number,
                                            c2880645_ttime.drivers.document_id,
                                            c2880645_hubtec.documents.name_short document_type,
                                            c2880645_ttime.drivers.document_number,
                                            c2880645_ttime.drivers.address,
                                            c2880645_ttime.drivers.created_at,
                                            c2880645_ttime.drivers.state
                                        FROM
                                            c2880645_ttime.drivers
                                        INNER JOIN
                                            c2880645_hubtec.documents
                                        ON
                                            c2880645_hubtec.documents.id = c2880645_ttime.drivers.document_id
                                        WHERE
                                            c2880645_ttime.drivers.environment = :environment
                                        ORDER BY
                                            c2880645_ttime.drivers.id DESC
                                    ");
