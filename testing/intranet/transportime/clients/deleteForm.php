...
<html lang="es">
    ...
    <body>
        <?php
            $decryptedIdClient = encrypt_decrypt('decrypt', $_GET['id']);

            $data_update = [
                'id' => $decryptedIdClient,
            ...
            $stmt_update = "
                ...
                SET
                    c2880645_ttime.clients.state = 0
                WHERE
                    c2880645_ttime.clients.id = :id
            ...
            $stmt_insert_logging= "
                ...
                VALUES
                    ('DELETE',  200,    'clients',      :row_id,    :user_id,   :environment)
            ";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="py-3 text-center">
                    <h1 class="display-6">Eliminar cliente</h1>
                </div>
            </div>
