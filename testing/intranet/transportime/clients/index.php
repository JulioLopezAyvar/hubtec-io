            ...
            <main class="main-content">
                <div class="container">
                    <div class="alert alert-warning text-center" role="alert">
                        <i class="ri-alarm-warning-line"></i> Estás en el ambiente de [PRUEBAS] <i class="ri-alarm-warning-line"></i>
                    </div>
                </div>
                                ...
                                <div class="modal-dialog modal-xl">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="newClientLabel">Nuevo cliente</h1>
                                        ...
                                        <div class="modal-body">
                                            <div class="container-fluid">
                                                <form class="form-horizontal" id="form">
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <label for="full_name" class="form-label">Nombre completo <font style="color:red">(*)</font></label>
                                                            <input type="text" class="form-control" id="full_name" name="full_name" required>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <label for="email" class="form-label">Correo electrónico <font style="color:red">(*)</font></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <label for="document_type" class="form-label">Tipo de documento <font style="color:red">(*)</font></label>
                                                            <select class="form-select" id="document_type" name="document_type" required>
                                                                <option value="" selected>Seleccione tipo de documento</option>
                                                                <?php
                                                                    $stmt = $conn->prepare("
                                                                        SELECT
                                                                            c2880645_hubtec.documents.id,
                                                                            c2880645_hubtec.documents.name_short
                                                                        FROM
                                                                            c2880645_hubtec.documents
                                                                        ORDER BY
                                                                            c2880645_hubtec.documents.id
                                                                    ");
                                                        ...
                                                        <div class="col-sm-6">
                                                            <label for="document_number" class="form-label">Número de documento <font style="color:red">(*)</font></label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <label for="department" class="form-label">Departamento <font style="color:red">(*)</font></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <label for="province" class="form-label">Provincia <font style="color:red">(*)</font></label>
                                                            <select class='form-control' id='province' name='province' required>
                                                                <option value="">Seleccione provincia</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <label for="district" class="form-label">Distrito <font style="color:red">(*)</font></label>
                                                            <select class='form-control' id='district' name='district' required>
                                                                <option value="">Seleccione distrito</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <label for="address" class="form-label">Dirección <font style="color:red">(*)</font></label>
                                ...
                                <?php
                                    $stmt = $conn->prepare("
                                        SELECT
                                            ...
                                            c2880645_ttime.clients.email,
                                            c2880645_ttime.clients.phone_number,
                                            c2880645_ttime.clients.document_id,
                                            c2880645_hubtec.documents.name_short document_type,
                                            c2880645_ttime.clients.document_number,
                                            c2880645_ttime.clients.address,
                                            c2880645_ttime.clients.created_at,
                                            c2880645_ttime.clients.state
                                        FROM
                                            c2880645_ttime.clients
                                        INNER JOIN
                                            c2880645_hubtec.documents
                                        ON
                                            c2880645_hubtec.documents.id = c2880645_ttime.clients.document_id
                                        WHERE
                                            c2880645_ttime.clients.environment = :environment
                                        ORDER BY
                                            c2880645_ttime.clients.id DESC
                                    ");
                                    ...
                                    foreach ($stmt->fetchAll() as $row) {
                                        ...
                                        echo "
                                            <tr data-bs-toggle='collapse' data-bs-target='#demo" . $counter . "'>
                                                ...
                                                <td>" . $row["full_name"] . "</td>
                                                <td>" . (isset($row["email"]) ? $row["email"] : "<span class='badge text-bg-warning'>Sin registro</span>") . "</td>
                                                <td>" . (isset($row["phone_number"]) ? $row["phone_number"] : "<span class='badge text-bg-warning'>Sin registro</span>") . "</td>
                                                <td>" . $row["document_type"] . "<br>" . $row["document_number"] . "</td>
                                                <td>" . (isset($row["address"]) ? $row["address"] : "<span class='badge text-bg-warning'>Sin registro</span>") . "</td>
                                        ...
                                        ";
                                                            ...
                                                            $stmt_logging = $conn->prepare("
                                                                ...
                                                                WHERE
                                                                    c2880645_ttime.logging.object = 'drivers'
