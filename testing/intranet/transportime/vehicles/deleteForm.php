...
<html lang="es">
    ...
    <body>
        <?php
            $decryptedIdVehicle = encrypt_decrypt('decrypt', $_GET['id']);

            $data_update = [
                'id' => $decryptedIdVehicle,
            ...
            $stmt_update = "
                ...
                SET
                    c2880645_ttime.vehicles.state = 0
                WHERE
                    c2880645_ttime.vehicles.id = :id
            ...
            $stmt_insert_logging= "
                ...
                VALUES
                    ('DELETE',  200,    'vehicles',     :row_id,    :user_id,   :environment)
            ";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="py-3 text-center">
                    <h1 class="display-6">Eliminar vehículo</h1>
                </div>
            </div>
