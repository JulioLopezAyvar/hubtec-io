...
<html lang="es">
    ...
    <body>
        <?php
            $decryptedIdprovider = encrypt_decrypt('decrypt', $_GET['id']);

            $data_update = [
                'id' => $decryptedIdprovider,
            ...
            $stmt_update = "
                ...
                SET
                    c2880645_ttime.providers.state = 0
                WHERE
                    c2880645_ttime.providers.id = :id
            ...
            $stmt_insert_logging= "
                ...
                VALUES
                    ('DELETE',  200,    'providers',    :row_id,    :user_id,   :environment)
            ";
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="py-3 text-center">
                    <h1 class="display-6">Eliminar proveedor</h1>
                </div>
            </div>
